	...
	<div class="main-content pc fs-25 pb0">Task Manager</div>
		<div class="main-content">
			<div class="mid-content">
				<div class="d-flex fs-20"><div class="task-item pr ">My Tasks(<span id="my_tasks"></span>)</div><a href="<?php echo base_url()?>lsa_assoc" class="task-item pr active">Assigned Tasks(<span id="assigned_tasks"></span>)</a></div>
			...
			<div class="right-content">
				...
				<div class="card task-right br-14 my-task-container" id="task_info_box">
					<div class="fs-20 fw-600 m-b-5 blue-text">Assigned Tasks</div>
