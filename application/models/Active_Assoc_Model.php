...
class Active_Assoc_Model extends CI_Model{
		...
		foreach ($query->result() as $row) {
			$output.='
					<tr>
						...
						<td>
							<img src="http://localhost/assignment-12/assets/images/1.png" alt="" width="50px">
						</td>
						<td>
